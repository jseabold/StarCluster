...
def autocomplete(parser,
    ...
    if debugfn:
        ...
        f.wrte('---------------------------------------------------------')
        f.write('\n')
        f.write('CWORDS' + cwords + '\n')
        f.write('CLINE' + cline + '\n')
        f.write('CPOINT' + cpoint + '\n')
        f.write('CWORD' + cword + '\n')
        f.write('\nShort options' + '\n')
        f.write(pformat(parser._short_opt) + '\n')
        f.write('\nLong options' + '\n')
        f.write(pformat(parser._long_opt) + '\n')
        f.write('Prefix/Suffix:' + prefix + suffix + '\n')
        f.write('completions' + completions + '\n')
        f.close()
